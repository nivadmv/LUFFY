...
- **Data Processing**: ✅ Batch dimension operations implemented (core fold/unfold done, 5 optimization TODOs remain)
...
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:43** - Placeholder - TODO
...
- [ ] **luffy/verl/verl/models/llama/megatron/modeling_llama_megatron.py:37** - Review and clean up
...
- [ ] **luffy/verl/verl/protocol.py:136** - Optimize tensor view operations for performance (optimization pass)
- [ ] **luffy/verl/verl/protocol.py:137** - Add error handling for invalid batch dimensions (edge case pass)
- [ ] **luffy/verl/verl/protocol.py:169** - Add consistency check in DataProto
- [ ] **luffy/verl/verl/protocol.py:265** - Lift restriction on batch size compatibility if needed
- [ ] **luffy/verl/verl/protocol.py:351** - Clarify whether to copy data in select()
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_3_1/llm_engine_sp.py:586** - seq_group_metadata_list=seq_group_metadata_list, # check this input
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_3_1/llm_engine_sp.py:661** - we may not need to decode
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_3_1/model_loader.py:67** - "ScaledActivation.weight_loader": ScaledActivation, # (shengguangming): latest commit in vllm fix awq for this function and add load_weights
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/megatron_weight_loaders.py:272** - "ScaledActivation.weight_loader": ScaledActivation, # (shengguangming): latest commit in vllm fix awq for this function and add load_weights
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/parallel_state.py:236** - cpu_group = torch.distributed.new_group(ranks, backend="gloo") # this will hang
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_4_2/parallel_state.py:245** - ps._TP_CPU_GROUP = cpu_group # will hang when used with device mesh
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/arg_utils.py:53** - served_model_name = None # (sgm): check this
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/arg_utils.py:54** - tokenizer: Optional[str] = None # (sgm): check this
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/llm.py:148** - self.llm_engine = LLMEngine.from_engine_args(model, tokenizer, engine_args) # check usagecontext
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/megatron_weight_loaders.py:272** - "ScaledActivation.weight_loader": ScaledActivation, # (shengguangming): latest commit in vllm fix awq for this function and add load_weights
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:138** - use_custom_allreduce=False, # check why True is not work in Ray trainer
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:165** - use_custom_allreduce=False, # check why True is not work in Ray trainer
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:177** - init using device mesh (not support hybrid engine now)
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/parallel_state.py:249** - use_custom_allreduce=False, # check why True is not work in Ray trainer
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_5_4/worker.py:84** - self.is_driver_worker = is_driver_worker # we don't need driver
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/llm.py:147** - self.llm_engine = LLMEngine.from_engine_args(model, tokenizer, engine_args) # check usagecontext
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/megatron_weight_loaders.py:273** - "ScaledActivation.weight_loader": ScaledActivation, # (shengguangming): latest commit in vllm fix awq for this function and add load_weights
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:144** - use_custom_allreduce=False, # check why True is not work in Ray trainer
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:172** - use_custom_allreduce=False, # check why True is not work in Ray trainer
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:185** - init using device mesh (not support hybrid engine now)
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/parallel_state.py:257** - use_custom_allreduce=False, # check why True is not work in Ray trainer
...
- [ ] **luffy/verl/verl/third_party/vllm/vllm_v_0_6_3/worker.py:92** - self.is_driver_worker = is_driver_worker # we don't need driver
...
- [ ] **luffy/verl/verl/trainer/fsdp_sft_trainer.py:178** - self.fsdp_model = None # Initialize FSDP wrapped model
...
- [ ] **luffy/verl/verl/utils/checkpoint/fsdp_checkpoint_manager.py:135** - torch.save(optimizer_state_dict, optim_path) # address optimizer is None
...
- [ ] **luffy/verl/verl/workers/fsdp_workers.py:197** - may not in torch_dtype. (zhangchi.usc1992) remove this after we switch to fsdp2
...
- [ ] **luffy/verl/verl/workers/reward_model/megatron/reward_model.py:145** - dtype=torch.bfloat16, # (sgm): check why is bfloat16
